...
for data in @bsan_data do
    Room.create(code: data[0], name: data[1], capacity: data[2], active: true, time_grid_id: 1, course_id: 2, building_id: 4, details: "Nada informado", category_ids: [2],  computers: 0)
end