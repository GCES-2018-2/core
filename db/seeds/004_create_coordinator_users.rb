...
coordinator = Coordinator.find_or_create_by(user: user, course_id: 5)
...
coordinator_2 = Coordinator.find_or_create_by(user: user_2, course_id: 6)
...
coordinator_3 = Coordinator.find_or_create_by(user: user_3, course_id: 6)