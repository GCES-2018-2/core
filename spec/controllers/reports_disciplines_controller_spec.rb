...
RSpec.describe ReportsDisciplinesController, type: :controller do
    before(:each) do
      ...
      @room_2 = Room.create(code: 'S11', name: 'Superior 10', capacity: 50, computers: 50, active: true, time_grid_id: 1, building: @building, details: "Nada informado", course: @course )
