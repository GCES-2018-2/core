...
RSpec.describe ReportsDisciplinesController, type: :controller do
    before(:each) do
      ...
      @school_room2 = SchoolRoom.create(name:"AAA", vacancies: 50, discipline: @discipline3, course_ids: [@course.id], coordinator_id: @coordinator.id)
      @school_room3 = SchoolRoom.create(name:"BBB", vacancies: 50, discipline: @discipline3, course_ids: [@course.id], coordinator_id: @coordinator.id)
      @room = Room.create(code: 'S10', name: 'Superior 10', capacity: 50, active: true, time_grid_id: 1, building: @building, details: "Nada informado", course: @course )
      @room_2 = Room.create(code: 'S11', name: 'Superior 10', capacity: 50, active: true, time_grid_id: 1, building: @building, details: "Nada informado", course: @course )
