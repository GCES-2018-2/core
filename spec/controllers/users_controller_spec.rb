...
#    end
  ...
  describe 'Show methods' do
    ...
    before(:each) do
      ...
      @room_solicitation = RoomSolicitation.create(solicitation_id: @solicitation.id,start: '10-01-2018 18:00:00',final: '10-01-2018 20:00:00',day: "Sabado",course_id: @course.id)
    end
