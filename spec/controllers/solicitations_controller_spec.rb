...
RSpec.describe SolicitationsController, type: :controller do
  ...
  describe 'approve_solicitation' do
    before(:each) do
      ...
      @room_4 = Room.create(code: '987654', name: 'S8', capacity: 80, computers: 0, active: true, time_grid_id: 1, department: @department, building: @buildings[1], details: "Nada informado", category_ids: [@category.id])
