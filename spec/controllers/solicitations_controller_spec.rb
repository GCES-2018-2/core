...
RSpec.describe SolicitationsController, type: :controller do
  ...
  describe 'Solicitation allocation in allocation period' do
    before(:each) do
      ...
      @school_room1 = SchoolRoom.create(name:"YY", vacancies: 50, discipline: @discipline1, course_ids: [@course1.id], coordinator_id:@coordinator.id)
  ...
  describe 'Solicitation allocation in adjustment period' do
    before(:each) do
      ...
      @coordinator2 = Coordinator.create(user: @user2, course: @course2)
      @deg = Deg.create(user: @user3)
      @school_room1 = SchoolRoom.create(name:"YY", vacancies: 50, discipline: @discipline1, course_ids: [@course1.id, @course3.id], coordinator_id:@coordinator.id)
