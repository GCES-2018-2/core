...
RSpec.describe ReportsController, type: :controller do
  describe 'report controller methods' do
    before(:each) do
      ...
      @building2 = Building.create(code: 'FT', name: 'FT')
      ...
      @room_2 = Room.create(code: 'S11', name: 'Superior 11', capacity: 50, active: true, time_grid_id: 1, building: @building, details: "Nada informado", course: @course )
